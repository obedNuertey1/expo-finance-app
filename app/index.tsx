  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.wrapper}>
            ...
            <Animated.Text style={styles.description} entering={FadeInRight.delay(700).duration(500)}>Get breaking news and personal updates directly to your feed.</Animated.Text>
            <Animated.View
